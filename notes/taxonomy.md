...
|---|---|---|---|---|---|---|---|---|
| 0 | Toolchain | Reproducible study notebooks | [notebooks/toolchain/marimo/001_basics.py](../notebooks/toolchain/marimo/001_basics.py) · [curriculum index](../notebooks/toolchain/curriculum/001_index.py) | `architecture/{marimo,uv,ruff,pytest}` | marimo, uv, ruff, ty, pytest, rich | permissive (Apache-2.0 / MIT) | L2 | existing |
...
| B | B3 | Distributed data & streaming — analytics (task graphs → shuffle → exactly-once) | [pyarrow seed](../notebooks/data/pyarrow/001_columnar_memory.py) · [arrow zero-copy synergy](../notebooks/data/pyarrow/002_zero_copy_synergy.py) | `architecture/{arrow,spark,flink,kafka,ray,daft,pulsar,hadoop,pig}` | pyarrow, Spark, Flink, Kafka, Ray, Daft, Pulsar [all Apache-2.0] | permissive | L2 | seed |
