...
| F | F4 | Security, privacy & governance (PII → redaction → audit) | [pii-governance seed](../notebooks/enterprise/presidio/001_pii_governance.py) | `architecture/{presidio,opensearch}` | presidio [MIT], stdlib re/hashlib [PSF] | permissive | L4 | seed |
